...
from strategy.maker_taker_arb import MakerTakerArb
...
def parse_arguments():
    ...
    parser.add_argument('--maker', type=str, default='edgex',
                        help='Maker exchange to use (edgex, paradex, grvt). Default: edgex')
    ...
    parser.add_argument('--long-threshold', type=Decimal, default=Decimal('10'),
                        help='Long threshold for maker exchange (default: 10)')
    parser.add_argument('--short-threshold', type=Decimal, default=Decimal('10'),
                        help='Short threshold for maker exchange (default: 10)')
    return parser.parse_args()


def validate_exchange(exchange):
    """Validate that the exchange is supported."""
    supported_exchanges = ['edgex', 'paradex', 'grvt']
...
async def main():
    ...
    # Validate exchange
    validate_exchange(args.maker)

    try:
        bot = MakerTakerArb(
            maker_exchange=args.maker.lower(),
